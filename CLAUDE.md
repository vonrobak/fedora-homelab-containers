...
**Architectural decisions recorded as ADRs — latest is ADR-043** (see `docs/*/decisions/` for full details; number new ADRs sequentially from the latest)
